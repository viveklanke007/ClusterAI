...
import { Sparkles, Image as ImgIcon, Type, Mic } from "lucide-react";

export default function Home() {
  return (
    /* 🔒 FORCE DARK MODE CONTAINER */
    <div className="bg-black text-gray-300 min-h-screen">
      <div className="max-w-7xl mx-auto py-24 px-6 text-center relative">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-800/50 border border-gray-700 text-cyan-300 text-sm mb-6"
        >
          <Sparkles size={18} />
        ...
        >
          A fully loaded AI studio where you can generate text, images, audio,
          and more — lightning fast, beautifully designed, and incredibly easy
          to use.
        </motion.p>
        ...
        >
          ...
          <Link
            href="/register"
            className="bg-black/40 backdrop-blur-xl border border-gray-700 px-10 py-4 rounded-xl text-lg hover:bg-black/60 transition-all"
          >
            Join Free
          </Link>
        </motion.div>
        ...
        >
          <div className="relative w-full max-w-4xl rounded-3xl overflow-hidden border border-gray-700 bg-gray-900/60 backdrop-blur-xl p-6 shadow-2xl">
            <motion.div
              animate={{ y: [0, -6, 0] }}
...
function FeatureCard({ icon, title, desc }) {
  return (
    <motion.div
      ...
      className="p-6 bg-gray-900/70 border border-gray-700 rounded-2xl shadow-xl backdrop-blur-xl"
    >
